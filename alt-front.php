...
<?php
// get directory for use in code below
                ...
                <div class="ct" id="code">
                    <div class="ct" id="resume">
                        <ul id="home-menu">
                            ...
                            <a href="/wp/bio/">
                                <li class="icon2 fas fa-book" title="Bio" style="color: white"></li>
                            </a>
                        ...
                        <div class="alt-page" id="p2">
                            <section class="icon fas fa-envelope-open">
                        ...
                        <div class="alt-page" id="p3">
                            <section class="icon fab fa-wordpress">
                                <p class="hint">WordPress Sites</p>
                                <p class="hint"><a href="http://howtobathbombs.com/wp"
                                                   target="_blank">How To Bath Bombs</a></p>
                                <p class="hint"><a href="http://www.xmfg.com/" target="_blank">XMFG.com</a></p>
                        ...
                        <div class="alt-page" id="p4">
                            ...
                            <section class="icon fab fa-java">
                                ...
                                <p class="hint">
                                    ...
                                    <a href="https://github.com/JenJetson?tab=repositories" target="_blank">Go to my GitHub
                                        Repository here.</a></p>
                                ...
                                <p class="hint">
                                    ...
                                    <a href="https://github.com/JenJetson?tab=repositories" target="_blank"><img
                                                src="<?php echo $directory ?>/images/github-logo.png" width="50"
                                                height="50" alt="Github link"></a>
                                </p>
                        ...
                        <div class="alt-page" id="p5">
                            <section class="icon"><img src="<?php echo $directory ?>/images/picture.png" alt="picture"
                                ...
                                <p class="hint">I am a seasoned WordPress / PHP developer who is also interested in Java
                                    development.</p>
                                <p class="hint">I am based in Las Vegas and am also open to re-location or remote
                                    work.</p>
                                <p class="hint" style="color:darkorange">Get a copy of my resume
                                    <a href="http://jenjetson/wp/resume.php" target="_blank">here.</a>
